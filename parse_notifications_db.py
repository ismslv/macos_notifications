# Parses the Notifications db found on mac OSX systems.
# This database is located at: /private/var/folders/<xx>/<yyyyyyy>/0/com.apple.notificationcenter/db2/db
# xx and yyyyyyy are random and differ for each user and installation of OSX

# Usage: macNotifications.py  <path_to_database>  <output_file.csv>
# Output is a tab-delimited file which can be viewed using Excel or any text/spreadsheet viewer.
# The output has the following columns pulled from db tables and embedded plists blobs:
